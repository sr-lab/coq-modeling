...
class ReasoningCollatorConf(ProofPremiseCollatorConf):
    ...
    @classmethod
    def from_conf(cls, conf: ReasoningCollatorConf) -> ReasoningCollatorConf:
        return ReasoningCollatorConf(
            conf.script_tokens,
            conf.state_tokens,
            conf.proof_tokens,
            conf.premise_tokens,
...
class LmProcessedDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> Any:
        ...
        if self.train_type == "unsloth-grpo":
            ...
            return {
                "prompt": messages,  # Return raw messages, not pre-formatted text
